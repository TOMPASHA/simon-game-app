...
interface SimonBoardProps {
  ...
  onSubmit?: () => void; // Deprecated - auto-submit handles this now
  disabled?: boolean;
  // Step 3: Timer props
...
export const SimonBoard: React.FC<SimonBoardProps> = ({
  ...
  return (
    <div className="game-area flex flex-col items-center gap-3 sm:gap-4 md:gap-6 w-full max-w-md px-4 sm:px-2">
      ...
      {/* Status indicator when sequence complete (auto-submitting) */}
      {isInputPhase && canSubmit && (
        <div className="text-center animate-pulse">
          <span className="text-yellow-400 font-bold text-lg">⏳ Checking...</span>
        </div>
      )}
